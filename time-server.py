...
import cherrypy, argparse, time, datetime;

parser = argparse.ArgumentParser(description="Test Time Server.");
parser.add_argument("--ver", "--version", action="version", version="Test Time Server 0.0.1");
parser.add_argument("--port", "--port-number", default=4123, help="port number to use for server.");
